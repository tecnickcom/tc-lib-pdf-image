...
1. [Fork the repository](https://github.com/tecnickcom/tc-lib-pdf-image/fork) and create a branch from `main`:
   ```bash
...
1. **Open a Feature Request** on [GitHub Issues](https://github.com/tecnickcom/tc-lib-pdf-image/issues/new) describing the use case and proposed API.
